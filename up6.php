...
$up = "update storefronts set status='enable' where id=9";
$qry = mysql_query($up);
if ($qry)
    echo "UPDATED";
$up = "update storefronts set status='enable' where id=12";
$qry = mysql_query($up);
if ($qry)
    echo "UPDATED";
$up = "update storefronts set status='enable' where id=13";
$qry = mysql_query($up);
if ($qry)
    echo "UPDATED";
?>