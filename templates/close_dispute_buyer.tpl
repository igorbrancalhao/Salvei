...
<table width="958" cellpadding="0" cellspacing="0" border=0 align="center">
    ...
    <tr><td style="border-left:1px solid #CCCCCC; border-right:1px solid #cccccc; border-bottom:1px solid #cccccc; background-repeat:repeat-x; background-position:bottom"  background="images/contentgrad.jpg">
            <table align="center" cellpadding="3" cellspacing="3" width="100%">
                ...
                {
                ?>
                <form name="closefrm" method="post" action="close_dispute_buyer.php">
                    <tr><td class="banner1" style="padding-left:20px">Select an option to close the dispute<font color="#FF0000">*</font>
                        </td></tr>
                    <tr><td>&nbsp;</td></tr>
                    <?
                    if($err_flag==1)
                    ...
                    ?>
                    <tr><td style="padding-left:20px;" class="banner1"><input type="radio" value="1" name="close">Item received from seller
                        </td></tr>
                    <tr><td class="banner1" style="padding-left:20px"><input type="radio" value="2" name="close">Item not yet received from seller
                        </td></tr>
                    <tr><td>&nbsp;</td></tr>
                    <input type="hidden" name="cansave" value="1">
                    <input type="hidden" name="item_id" value="<?=$item_id?>">
                    <tr><td align="center"><input type="submit" name="submit" value="Close Dispute">
                        </td></tr>
                </form>
                <?
                }
                ...
                <tr><td><table border=0 align="center" cellpadding="0" cellspacing="3" width="100%">
                            <tr><td class="banner1" align="center"><font color="#FF0000">
                                    ...
                                    {
                                    ?>
                                    You must wait <?= $adminvalue?> <? if($adminvalue==1){ echo "day";} else {echo "days";}?> to close the dispute</font>
                                    <?
                                    }
                                    else
                                    {
