...
<table width="980" border="0" cellpadding="0" cellspacing="0" align="center">
 ...
 <?php 
                                                        ...
                                                        <tr><td width=250><input type="text" name="txtusername" class="txtmed" maxlength="10" value=<?php '$username';?> ></td></tr>
                                                        <tr>
                                                            <td class="detail9txt">
                                                                <?php  if(!empty($err_pass))
                                                                {?>
 ...
 <?php 
                                                        ...
                                                        <tr><td width=250 class="detail9txt">
                                                                <input type="password" name="txtpass" class="txtmed" value=<?php '$pass'; ?>><br>
                                                                6 character minimum.
                                                        ...
                                                        <tr><td colspan="2" class="detail9txt"> 
                                                                ...
                                                                {
                                                                ?>
                                                                <img src="images/warning_9x10.gif">&nbsp;<font color=red><?php '$err_repass' ?></font>
                                                                <br>
