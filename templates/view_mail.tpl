...
<td width=70%>
 <?php
      if($curpage!=1) 
	     {
         ?>
           <a href="view_mail.php?qst_id=<?php=$pre_id;?>&mode=<?php=$mode?>&vm=pre&curpage=<?php=($curpage-1);?>" class="header_text">Prev</a> 
            | 
            <?php
            }
           ?>
		   ...
		   {
           ?>
		   <a href="view_mail.php?qst_id=<?php=$next_id?>&mode=<?php=$mode?>&vm=next&curpage=<?php=($curpage+1);?>" class="header_text">Next</a> 
            <?php
            }
            ?>
</td>
...
{?><b> Question For item Id : <?php= $item_row[item_id] ?> - <?php= $item_row[item_title] ?> </b><?php}else {echo $mail_row[answer];}?></td></tr>
<tr><td width=10% class="detail9txt">From:</td><td class="detail9txt"><?phpif($mail_row['status']!="notification"){ ?><?php= $user_row[user_name]; ?><?php}else{?>Admin<?php}?> </td></tr>
<tr><td width=10% class="detail9txt">To:</td><td class="detail9txt"> <?php= $to_user_row[user_name]; ?> </td></tr>
</table>
</td></tr>
<tr><td>&nbsp; </td></tr>
<tr  bgcolor="#B8DEEE" height="35" class="detail9txt">
<td>&nbsp;<b>Mail From <?php= $user_row[user_name]; ?></b></td>
</tr>
<?php
...
<table width="100%">
<tr>
  <td class="detail9txt"><?php= $fromid; ?> sent this message on behalf of an <?php= $fromid; ?> member via My Messages. Responses sent using email will go to the <?php= $fromid; ?> member directly and will include your email address. Click the Reply button below to send your response via My Messages (your email address will not be included). </td>
</tr>
<tr><td ><hr></td></tr>
<tr><td class="detail9txt"><?php= $message; ?> </td></tr>
...
<input type="hidden" name="item_id" value=<?php= $item_row[item_id] ?> />
<input type="hidden" name="qst_id" value=<?php= $mail_row[qst_id] ?> />
<input type="hidden" name="mailmode"/>
<input type="hidden" name="checkmode" value="<?php=$mode?>"/>
...
<tr><td bgcolor="#F0F0F0">
<table width="100%" cellpadding="5" cellspacing="0" >
<tr><td width=20% class="detail9txt">Item Name:</td><td class="header_text"><b>  <?php= $item_row[item_title] ?> </b></td></tr>
<tr bgcolor="white"><td width=20% class="detail9txt">Item Number:</td><td class="header_text"><?php= $item_row[item_id] ?> </td></tr>
...
<?phpif($item_row[selling_method]=='ads')
{
?>
<tr><td>&nbsp;&nbsp;<a href="classifide_ad.php?item_id=<?php= $item_row[item_id]?>" class="header_text"><?php= $item_row[item_title] ?></a></td></tr>
<?php
}
else if($item_row[selling_method]=='want_it_now')
{
?>
<tr><td>&nbsp;&nbsp;<a href="wantitnowdes.php?item_id=<?php= $item_row[item_id]?>" class="header_text"><?php= $item_row[item_title] ?></a></td></tr>
<?php
}
else 
{
?>
<tr><td>&nbsp;&nbsp;<a href="detail.php?item_id=<?php= $item_row[item_id]?>" class="header_text"><?php= $item_row[item_title] ?></a></td></tr>
<?php
}
?>
...
<table width="100%">
<tr><td class="detail9txt">Admin sent this message on behalf of an <?php= $fromid; ?> </td></tr>
<tr><td ><hr></td></tr>
<tr><td><?php= $mail_row['question']; ?> </td></tr>
<tr><td><br /></td></tr>
<?php
}
?>
<tr><td class="detail9txt">&nbsp;&nbsp;Thanking You for using <?php= $fromsitename ?> </td></tr>
<tr><td>&nbsp;&nbsp; <?php= $fromname ?>  </td></tr>
</table>
</td></tr>
