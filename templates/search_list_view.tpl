...
?>
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td width="10" background="images/center-esquerda.jpg">&nbsp;</td>
                  <td><a href="detail.php?item_id=<?php echo $bestsellers_fetch['item_id'];?>" class="bestsellerstxt"></a>
                      <table <?php if ($both=="highlight"){?>style="border:1px solid #000066; background-repeat:repeat-x; background-position:bottom; padding-left:5px"<?php}?> width="100%" border="0" cellspacing="0" cellpadding="0" height="80px">
     ...
     list($widthp, $heightp, $typei, $attri) = getimagesize($imglarge);
									...
									$w=$nw;}
	 ?>
                                    <a href="detail.php?item_id=<?php echo $item['item_id']?>"> <img src="<?php echo $fimg?>" width="52" height="32"  onmouseover="showtrail('<?php echo $imglarge?>','Featured',<?php echo $widthp?>,<?php echo $heightp?>)" onmouseout="hidetrail()" align="top" border="0" /> </a>
     ...
     list($widthp, $heightp, $typei, $attri) = getimagesize($imglarge);
									...
									$w=$nw;}
	 ?>
                                    <a href="classifide_ad.php?item_id=<?php echo $item['item_id']?>"> <img src="<?php echo $fimg?>" width="52" height="32"  onmouseover="showtrail('<?php echo $imglarge?>','Featured',<?php echo $widthp?>,<?php echo $heightp?>)" onmouseout="hidetrail()" align="top" border="0" /> </a>
                                    <div style="display: none; position: absolute;z-index:110;" id="preview_div"></div>
                                  <?php
	 }
	 }
	 ...
	 {
	 ?>
                                    <a href="detail.php?item_id=<?php echo $item['item_id']?>"> <img src="images/no-image.gif" alt="" width="52" height="38" border="0"/> </a>
                                    <?php
	 }
	 else
	 {
	 ?>
                                    <a href="classifide_ad.php?item_id=<?php echo $item['item_id']?>"> <img src="images/no-image.gif" alt="" width="52" height="38" border="0"/> </a>
                                    <?php
	 }
	 }
	 ?>
   ...
   <td><img src="images/zoom.gif" alt="" width="16" height="20" /></td>
     <td class="footer2txt"><a href="#" class="searchresult11txt"  onMouseOver="showtrail('<?php echo $imglarge?>','Featured',<?php echo $widthp?>,<?php echo $heightp?>)" onMouseOut="hidetrail()" align="top">Enlarge</a></td>
     </tr>-->
                          </table></td>
                          <td width="41%" rowspan="2"><table width="280" border="0" align="left" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><div align="justify" <?php if ($fea['bold']=='Yes'){?> class="searchresult3txt_bold" <?php}else {?>class="searchresult3txt"  <?php}?>>
                                    <div align="justify">
                                      <?php
	 if($item['selling_method']=='auction' || $item['selling_method']=='dutch_auction' || $item['selling_method']=='fix')
	 {
	 ?>
                                      <a href="detail.php?item_id=<?php echo $item['item_id'];?>" <?php if ($fea['bold']=='Yes'){?> class="searchresult3txt_bold" <?php}else {?>class="searchresult3txt"
  <?php}?>>
	 ...
	 {
	 ?>
                                      <a href="classifide_ad.php?item_id=<?php echo $item['item_id'];?>" <?php if ($fea['bold']=='Yes'){?> class="searchresult3txt_bold" <?php}else {?>class="searchresult3txt"
  <?php}?>>
                                      <?php echo $item['item_title'];?>
                                      </a>
                                      <?php
