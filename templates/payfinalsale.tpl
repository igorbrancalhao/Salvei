                ...
                <tr align="center" height=35>
                    ...
                    <td align="center">
                        <table cellpadding="2" cellspacing="2"><tr class="banner1"><td>
                                    You are paying the finalsalevalue fee of &nbsp;<b><?php=$default_cur?><?php= $amount ?></b> for item #<?php=$item_id?> for Sold Your Items&nbsp; .</td></tr>
                            <tr class="banner1"><td>
                        ...
                        <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                            ...
                            <tr><td align=center>
                                    <form action="https://www.e-gold.com/sci_asp/payments.asp" method=post>
                                        ...
                                        <input type="hidden" name="PAYMENT_URL" value="<?php=$yoursite;?>/finalsale_fee_success.php?fd=<?php=$fee_id?>&iid=<?php=$item_id?>&pid=3">
                        ...
                        <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                            <tr><td align=center>
                                    <form action="https://intgold.com/cgi-bin/webshoppingcart.cgi" target=_blank method="POST">
                                        ...
                                        <input type="hidden" name="RETURNURL" value="<?php=$yoursite;?>/finalsale_fee_success.php?fd=<?php=$fee_id?>&iid=<?php=$item_id?>&pid=2">
                        ...
                        <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                            ...
                            <tr><td align=center>
                                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                        ...
                                        <input type="hidden" name="item_name" value="Finalsalefee for Item#<?php=$item_id?>">
                                        <input type="hidden" name="amount" value="<?php echo $amount;?>">
                                        <input type="hidden" name="no_note" value="1">
                                        <input type="hidden" name="currency_code" value="<?php=$default_cur_code?>">
                                        <input type="hidden" name="rm" value="2">
                                        <input type="hidden" name="return" value="<?php=$yoursite;?>/finalsale_fee_success.php?fd=<?php=$fee_id?>&iid=<?php=$item_id?>&pid=1">
                                        <input type="hidden" name="cancel_return" value="<?php=$yoursite?>/failure.php ?>">
                        ...
                        <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                            ...
                            <tr><td align=center>
                                    <form method="post" action="https://www.stormpay.com/stormpay/handle_gen.php">
                                        ...
                                        <input type="hidden" name="return_URL" value="<?php=$yoursite;?>/finalsale_fee_success.php?fd=<?php=$fee_id?>&iid=<?php=$item_id?>&pid=3">
                        ...
                        <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                            ...
                            <tr><td align=center>
                                    ...
                                    <form name="atip" method="post" action="https://atip.e-bullion.com/process.php">
                                        ...
                                        <input type="hidden" name="ATIP_PAYMENT_URL" value="<?php=$yoursite;?>/finalsale_fee_success.php?fd=<?php=$fee_id?>&iid=<?php=$item_id?>&pid=5">
                        ...
                        <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                            ...
                            <tr><td align=center>
                                    ...
                                    <form action="https://www.moneybookers.com/app/payment.pl" target="_blank">
                                        ...
                                        <input type="hidden" name="return_url" value="<?php=$yoursite;?>/finalsale_fee_success.php?fd=<?php=$fee_id?>&iid=<?php=$item_id?>&pid=4">
                                        <input type="hidden" name="cancel_url" value="<?php=$yoursite?>/failure.php ?>">
