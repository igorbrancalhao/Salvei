                ...
                <tr align="center">
                    ...
                    <td  align="center">
                        <table cellpadding="0" cellspacing="5"><tr class="detail9txt"><td>
                                    You are paying $&nbsp;<b><?php= $amount ?></b> for Create Your Store&nbsp; .</td></tr>
            ...
            <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                <tr><td align=center>
                        <form action="https://www.e-gold.com/sci_asp/payments.asp" method="post">
                            ...
                            <input type="hidden" name="PAYMENT_URL" value="<?php=$yoursite;?>/storesuccess.php?payid=3">
            ...
            <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                <tr><td align=center>
                        <form action="https://intgold.com/cgi-bin/webshoppingcart.cgi" target=_blank method="POST">
                            ...
                            <input type="hidden" name="RETURNURL" value="<?php=$yoursite;?>/storesuccess.php?payid=2">
            ...
            <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                ...
                <tr><td align=center>
                        ...
                        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                            ...
                            <input type="hidden" name="return" value="<?php=$yoursite?>/storesuccess.php?payid=1">
                            <input type="hidden" name="cancel_return" value="<?php=$yoursite?>/failure.php">
            ...
            <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                ...
                <tr><td align=center>
                        <form method="post" action="https://www.stormpay.com/stormpay/handle_gen.php">
                            ...
                            <input type="hidden" name="return_URL" value="<?php=$yoursite;?>/storesuccess.php?payid=6">
            ...
            <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                ...
                <tr><td align=center>
                        ...
                        <form name="atip" method="post" action="https://atip.e-bullion.com/process.php">
                            ...
                            <input type="hidden" name="ATIP_PAYMENT_URL" value="<?php=$yoursite;?>/storesuccess.php?payid=5">
            ...
            <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                ...
                <tr><td align=center>
                        ...
                        <form action="https://www.moneybookers.com/app/payment.pl" target="_blank">
                            ...
                            <input type="hidden" name="return_url" value="<?php=$yoursite?>/storesuccess.php?payid=4">
                            <input type="hidden" name="cancel_url" value="<?php=$yoursite?>/failure.php ?>">
