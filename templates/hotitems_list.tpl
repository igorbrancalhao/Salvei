...
<tr class="tr_color_2">
    ...
    <td width=30 align=center>
        <a href="detail.php?item_id=<?php= $record['item_id'];?>&qty=1">
            ...
            {
            ?>
            <img src="images/auction(5).gif" border="0" alt="Click here ">
            <?php
            }
            else
            {
            ?>
            <img src="images/buynow_icon.gif" border="0" alt="Click here ">
            <?php
            }
            ?>
        </a>
