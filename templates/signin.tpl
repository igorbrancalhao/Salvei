...
<div id="login_left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td style="font-family:Tahoma; color:#475F96; font-size:18px; font-weight:bold">Bem vindo ao <?=$sitename_fetch['set_value']?><!--<img src="images/wel_img.gif" alt="" width="227" height="10" />--></td>
  </tr>
  <tr>
        <td height="10"></td>
  </tr>
...
<?=$sitename_fetch['set_value']?> e muito mais! </span><span class="banner1"></span></td>
          </tr>
        </table></td>
        </tr>
			...
			<? if(!empty($msg))
			   {
			     	?>
					<tr>&nbsp;</tr>
					<tr><td colspan="4"><font class="errormsg"><b><center><?= $msg; ?></center></b></font></td></tr>
					<?
				}
	       ?>
            <tr>
			...
			<input type="hidden" value="<?= urlencode($url);?>" name="url">
