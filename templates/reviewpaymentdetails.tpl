...
<table width="958" cellpadding="0" cellspacing="0" border=0 align="center">
    <tr width=100>
        <td colspan=3 background="images/contentbg1.jpg" height="25">
            <font class="detail3txt"><div align="left">
                &nbsp;&nbsp; Review Your Payment Details For Listing Item <?php echo  $item_title ?>( # <?php echo  $item_id ?> )</div></font></td></tr>
    ...
    <tr><td colspan="2" style="border-left:1px solid #CCCCCC; border-right:1px solid #cccccc; border-bottom:1px solid #cccccc; background-repeat:repeat-x; background-position:bottom"  background="images/contentgrad.jpg"> 
            <table cellpadding="5" cellspacing="2"  width=100%> 
                ...
                <tr><td class="categories_fonttype">To continue payment for <?php echo  $item_title ?>, select the Payment method at the bottom of the page. </td></tr>
                            ...
                            <tr><td><table width="100%" cellpadding="5" cellspacing="0" border=0 align="center">
                                        ...
                                        <tr><td align="center" colspan="3">
                                                <table cellpadding="5" cellspacing="2" width=50% >
                                                    ...
                                                    {
                                                    ?>
                                                    <tr bgclor=#eeeeee><td align="right"  class="categories_fonttype"><b>Insertion Fee:</b></td><td align="left" class="banner1"><?php echo  $fee_row[Insertion_fee] ?>&nbsp;<?php echo  $default_cur_code ?></td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    {
                                                    ?>
                                                    <tr bgclor=#eeeeee><td align="right"  class="categories_fonttype"><b>Insertion Fee:</b></td><td align="left" class="banner1"><?php echo  $fee_row[classifedad_fee] ?>&nbsp;<?php echo  $default_cur_code ?></td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    {
                                                    ?>
                                                    <tr bgclor=#eeeeee><td align="right"  class="categories_fonttype"><b>Reserve Price Fee</b></td><td align="left" class="banner1"><?php echo  $fee_row[reserve_price_fee] ?>&nbsp;<?php echo  $default_cur_code ?></td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    {
                                                    ?>
                                                    <tr bgclor=#eeeeee><td align="right"  class="categories_fonttype"><b>Gallery Item Fee:</b></td><td align="left" class="banner1"><?php echo  $fee_row[gallery_fee] ?>&nbsp;<?php echo  $default_cur_code ?></td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    ?>
                                                    <tr bgclor=white><td align="right"  class="categories_fonttype"><b>Bold Item Fee:</b></td><td align="left" class="banner1"><?php echo  $fee_row[boldlisting_fee] ?>&nbsp;<?php echo  $default_cur_code ?> </td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    ?>
                                                    <tr bgclor=#eeeeee><td align="right"  class="categories_fonttype"><b>Highlight Item Fee:</b></td><td align="left" class="banner1"><?php echo  $fee_row[highlighted_fee] ?>&nbsp;<?php echo  $default_cur_code ?> </td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    <tr bgclor=white><td align="right"  class="categories_fonttype"><b>Subtitle Item Fee:</b></td>
                                                        <td align="left" class="banner1"><?php echo $fee_row[subtitlefee] ?>&nbsp;<?php echo  $default_cur_code ?> </td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    {
                                                    ?>
                                                    <tr bgclor=#eeeeee><td align="right"  class="categories_fonttype"><b>Homepage Featured Item Fee:</b></td><td align="left" class="banner1"><?php echo  $fee_row[homepage_featureditem_fee] ?>&nbsp;<?php echo  $default_cur_code ?></td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    {
                                                    ?>
                                                    <tr bgclor=white><td align="right"  class="categories_fonttype"><b>Additional Pictures Fees:</b></td><td align="left" class="banner1"><?php echo  $fee_row[addtional_pic_fee] ?>&nbsp;<?php echo  $default_cur_code ?> </td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    ?>
                                                    <tr bgclor=#eeeeee><td align="right" class="categories_fonttype"><b>Listing Designer Fee:</b></td><td align="left" class="banner1"><?php echo  $fee_row[listing_desinger_fee] ?>&nbsp;<?php echo  $default_cur_code ?> </td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    <tr bgclor=white><td align="right" class="categories_fonttype"><b>Total Setup Fees:</b></td><td align="left" class="banner1"><?php echo  $total_setup_fee ?>&nbsp;<?php echo  $default_cur_code ?></td>
                                                    </tr>
                                                    <tr><td colspan="2"><hr /></td></tr>
                                                </table>
                                        <tr><td><font size="2">
                                        ...
                                        <form name="payment" method=post>
                                            <tr><td align="center">
                                                    <select name="paymentoption" style="font-size:15px; height:20px; width:180px; color:#666666" onchange="selpayment(this.value)">
                                                        ...
                                                        {
                                                        ?>
                                                        <option value="<?php echo $fetch_payment['gateway_id']?>" <?phpif($payid==$fetch_payment['gateway_id']) echo"selected=selected";?>><?php echo $fetch_payment['payment_gateway']?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
                                                ...
                                                <table border=0 align=center cellpadding=5 cellspacing=2 width=75% >
                                                    <tr><td align=center>
                                                            <form action="https://www.e-gold.com/sci_asp/payments.asp" method=post>
                                                                ...
                                                                <input type="hidden" name="PAYMENT_URL" value="<?php echo $yoursite;?>/success.php">
                                            ...
                                            <td align="left"><table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                                                    <tr><td align=center>
                                                            <form action="https://intgold.com/cgi-bin/webshoppingcart.cgi" target=_blank method="POST">
                                                                ...
                                                                <input type="hidden" name="RETURNURL" value="<?php echo $yoursite;?>/success.php">
                                            ...
                                            <td align="left"><table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                                                    ...
                                                    <tr><td align=center>
                                                            ...
                                                            <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                                                                ...
                                                                <input type="hidden" name="item_name" value="<?php echo  $row[item_id] ?>">
                                                                <input type="hidden" name="amount" value="<?php echo $amount;?>">
                                                                <input type="hidden" name="no_note" value="1">
                                                                <input type="hidden" name="currency_code" value="<?php echo  $default_cur_code ?>">
                                                                <input type="hidden" name="rm" value="2">
                                                                <input type="hidden" name="return" value="<?php echo $yoursite?>/success.php?amt=<?php echo $amount?>&pid=<?php echo $payid?>&usrd=<?php echo $_SESSION[userid]?>&itid=<?php echo $row[item_id]?>">
                                                                <input type="hidden" name="cancel_return" value="<?php echo $yoursite?>/failure.php">
                                            ...
                                            <td align="left"><table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                                                    ...
                                                    <tr><td align=center>
                                                            <form method="post" action="https://www.stormpay.com/stormpay/handle_gen.php">
                                                                ...
                                                                <input type="hidden" name="return_URL" value="<?php echo $yoursite;?>/success.php">
                                                ...
                                                <table border=0 align=center cellpadding=5 cellspacing=2 width=75% class="subtable">
                                                    <tr><td align=center>
                                                            ...
                                                            <form name="atip" method="post" action="https://atip.e-bullion.com/process.php">
                                                                ...
                                                                <input type="hidden" name="ATIP_PAYMENT_URL" value="<?php echo $yoursite;?>/success.php">
