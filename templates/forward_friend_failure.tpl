<?php
/***************************************************************************
*File Name				:forward_friend_failure.tpl
...
<table width="980" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr>
        <td><table width="943" border="0" align="center" cellpadding="0" cellspacing="0" background="images/contentgrad.jpg" style="border:1px solid #c4dbe7; background-repeat:repeat-x; background-position:bottom">
                ...
                <tr><td><br /></td></tr>
                <tr>
                    <td align="center"><font class="errormsg">Sorry, there is a Problem in sending your mail.Try Again Later.</font></td></tr>
                <tr align="center"><td align="center"><a href="index.php" class="header_text">Ok</a></td></tr>
                <tr><td><br /></td></tr>
            </table></td></tr>
