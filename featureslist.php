    ...
    <tr>
      <td><table width="0" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><div align="center"> <a href="detail.php?item_id=<?php=$fetch_featureslist['item_id']?>" target="_top"> <img src="thumbnail/<?php=$fetch_featureslist['picture1']?>" alt="" width="75" height="75" border="0"/> </a></div></td>
