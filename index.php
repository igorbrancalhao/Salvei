...
?>
 ...
 // {
  ...
  <a href="subcat.php?cate_id=<?php=$category_id[2]?>&view=list" class="linksrollovertxt"><?php=$category_name[2]?></a></td>
    ...
    <tr>
      <td bgcolor="#F8F8F8">&nbsp;</td>
      <td bgcolor="#F8F8F8" class="bestsellerstxt" id="category3"><a href="subcat.php?cate_id=<?php=$category_id[3]?>&view=list" class="linksrollovertxt"><?php=$category_name[3]?></a></td>
  ...
  <tr>
      <td bgcolor="#F8F8F8">&nbsp;</td>
      <td bgcolor="#F8F8F8" class="bestsellerstxt" id="category4"><a href="subcat.php?cate_id=<?php=$category_id[4]?>&view=list" class="linksrollovertxt"><?php=$category_name[4]?></a></td>
  ...
  <tr>
      <td bgcolor="#F8F8F8">&nbsp;</td>
      <td bgcolor="#F8F8F8" class="bestsellerstxt" id="category5"><a href="subcat.php?cate_id=<?php=$category_id[5]?>&view=list" class="linksrollovertxt"><?php=$category_name[5]?></a></td>
    ...
    <tr>
      <td bgcolor="#F8F8F8">&nbsp;</td>
      <td bgcolor="#F8F8F8" class="bestsellerstxt" id="category7"><a href="subcat.php?cate_id=<?php=$category_id[7]?>&view=list" class="linksrollovertxt"><?php=$category_name[7]?></a></td>
    ...
    <tr>
      <td bgcolor="#F8F8F8">&nbsp;</td>
      <td bgcolor="#F8F8F8" class="bestsellerstxt" id="category8"><a href="subcat.php?cate_id=<?php=$category_id[8]?>&view=list" class="linksrollovertxt"><?php=$category_name[8]?></a></td>
      ...
      <td width="46%"><div align="center">
        <table width="0" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td><a href="detail.php?item_id=<?php=$bestsellers_fetch['item_id'];?>" class="bestsellerstxt"><img src="thumbnail/<?php=$bestsellers_fetch['picture1'];?>" alt="" width="79" height="70" border="0" /></a><a href="detail.php?item_id=<?php=$endsoonitems_fetch['item_id']?>"></a></td>
        ...
        <a href="detail.php?item_id=<?php=$bestsellers_fetch['item_id'];?>" class="bestsellerstxt"></a></div></td>
            ...
            <tr>
              ...
              <td><a href="detail.php?item_id=<?php=$bestsellers_fetch['item_id'];?>" class="bestsellerstxt"></a>
                  <table width="0" border="0">
                    <tr>
                      <td align="center"><a href="classifide_ad.php?item_id=<?php=$ad_fetch['item_id']?>" class="spotlight1txt">
                        <?php=$ad_fetch['item_title']?>
                      </a></td>
                    </tr>
                    <tr>
                      <td align="center"><a href="classifide_ad.php?item_id=<?php=$ad_fetch['item_id']?>"><img src="thumbnail/<?php=$ad_fetch['picture1']?>" alt="" width="106" height="71" border="0"/></a></td>
                    </tr>
                  </table>
  ...
  <div class="bestbg">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="5%">&nbsp;</td>
        <td width="11%"><img src="images/categbullet.gif" alt="" width="8" height="7" /></td>
        <td width="84%"><span class="bestsellerstxt">Total de Usu&aacute;rios:</span> <span class="banner1"><?php=$totaluser_count;?></span></td>
      </tr>
      <tr>
        <td height="3"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><img src="images/categbullet.gif" alt="" width="8" height="7" /></td>
        <td><span class="bestsellerstxt">Produtos vendidos:</span> <span class="banner1"><?php=$totalsold_items?></span></td>
      </tr>
      <tr>
        <td height="3"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><img src="images/categbullet.gif" alt="" width="8" height="7" /></td>
        <td><span class="bestsellerstxt">Produtos cadastrados:</span> <span class="banner1"><?php=$total_items?></span></td>
      </tr>
      <tr>
        <td height="3"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><img src="images/categbullet.gif" alt="" width="8" height="7" /></td>
        <td><span class="bestsellerstxt">Usu&aacute;rios Online: </span><span class="banner1"><?php=$onlineusers_count?></span></td>
      </tr>
      <tr>
        <td height="3"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><img src="images/categbullet.gif" alt="" width="8" height="7"/></td>
        <td><span class="bestsellerstxt">Data do site : </span><span class="banner1"><?php=$sitestarted?></span></td>
      </tr>
      <tr>
        <td height="3"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><img src="images/categbullet.gif" alt="" width="8" height="7" /></td>
        <td><span class="bestsellerstxt">Dias no ar: </span><span class="banner1"><?php=$runningdays?> Dias</span></td>
      </tr>
      <tr>
        <td height="3"></td>
      </tr>
...
<div id="categories_right"><div id="products">
  <div class="products_bg">Melhores produtos do  <?php=$sitename_fetch['set_value']?></div>
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td width="6%">&nbsp;</td>
                        <td width="94%" class="prodtxt" id="prod<?php=$i?><?php=$j++?>"><a href="detail.php?item_id=<?php=$hotitems_fetch['item_id'];?>" class="prodtxt">
                          <?php=$item_subtitle;?>
                        </a></td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="52%"><table width="0%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td width="10" background="images/center-esquerda.jpg">&nbsp;</td>
                                  <td><div align="center"> <a href="detail.php?item_id=<?php=$hotitems_fetch['item_id'];?>" class="prodtxt"><a href="detail.php?item_id=<?php=$hotitems_fetch['item_id'];?>" class="prodtxt"> <img src="thumbnail/<?php=$hotitems_fetch['picture1'];?>" alt="" width="75" height="75" id="prod<?php=$i?><?php=$j++?>" border="0"/> </a> </div></td>
                                  <td width="10" background="images/center-direito.jpg">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td width="10" height="10" background="images/base-esquerda.jpg"><img src="images/base-esquerda.jpg" width="10" height="10" /></td>
                              ...
                              <td width="48%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td class="products1txt" id="prod<?php=$i?><?php=$j++?>"><?php=$item_title;?>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td height="8"></td>
                                  ...
                                  <tr>
                                    <td class="products2txt" id="prod<?php=$i?><?php=$j++?>"><?php=$hotitems_fetch['currency'];?>
                                        <?php=$hotitems_fetch['cur_price'];?></td>
                                  </tr>
                                  <tr>
                                    <td height="8"></td>
                                  </tr>
...
?>
 ...
 <?php echo $feed_tot['feedbacktotal']; ?></a><?php if($feedback_img!='') { ?><img src="images/<?php= $feedback_img ?>" /><?php } ?> )			  </td>
            </tr>
            <tr>
              <td height="4"></td>
            </tr>
            ...
            <tr>
              <td colspan="3" align="center"><a href="detail.php?item_id=<?php=$endsoonitems_fetch['item_id'];?>">
      ...
      <tr>
        <td colspan="2"><div align="center"><a href="detail.php?item_id=<?php=$endsoonitems_fetch['item_id']?>"></a>
          <table width="0" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="10" height="10" background="images/top-esquerda.jpg"><img src="images/top-esquerda.jpg" width="10" height="10" /></td>
              <td background="images/center-top.jpg"><img src="images/center-top.jpg" width="10" height="10" /></td>
            ...
            <tr>
              <td width="10" background="images/center-esquerda.jpg">&nbsp;</td>
              <td><a href="detail.php?item_id=<?php=$endsoonitems_fetch['item_id']?>"><img src="thumbnail/<?php=$endsoonitems_fetch['picture1']?>" alt="" width="150" height="150" border="0"/></a></td>
              <td width="10" background="images/center-direito.jpg">&nbsp;</td>
            </tr>
            <tr>
              <td width="10" height="10" background="images/base-esquerda.jpg"><img src="images/base-esquerda.jpg" width="10" height="10" /></td>
      ...
      <tr>
        <td width="3%">&nbsp;</td>
        <td width="45%" align="center"><span class="header_text3">Este produto termina exatamente em  </span><span class="bestsellerstxt"><?php=$string_difference;?></span></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
...
?>
		...
		?>
		<tr>
          <td><a href="<?php=$sqlfetch_banner2['url'];?>"><img src="images/b2eebgreenban.gif" height="259" width="278" border="0"/></a></td>
        </tr>
		<?php
		}
		?>
