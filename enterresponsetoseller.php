...
// now mail($mail_to,$subject,$message,$headers);
...
{
// $date = date("Y-m-d G:i:s"); 
 $up="update disputeconsole set dispute_status='$_REQUEST[radclose]' where dispute_id=$dispute_id";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Response Entered Successfully</div>
</font> </td></tr>
...
<tr><td style="border-left:1px solid #CCCCCC; border-right:1px solid #cccccc; border-bottom:1px solid #cccccc; background-repeat:repeat-x; background-position:bottom"  background="images/contentgrad.jpg">
<tr><td style="padding-left:5px" >
<b>Transaction:</b> <?php= $sell[item_title] ?> (#<?php= $bid[item_id] ?>) sold  by <?php= $sell[user_name] ?> on
 <?php
  $custom_date=explode(" ",$bid_date);
  $custom_date1=$custom_date[0];
  $custom_time=$custom_date[1];
...
<td width="60%">
<form name="review_form" action="close_dispute_buyer.php"  method=post>
<table>
<tr><td class="banner1"><b>Close This Dispute</b>  
</td></tr>
<tr><td class="banner1" style="padding-left:25px">You can close your dispute under following circumstances.</td></tr>
<tr><td class="banner1">
<ul type="disc">
