...
<table width="958" cellpadding="0" cellspacing="0" border=0 align="center">
    ...
    <tr><td style="border-left:1px solid #CCCCCC; border-right:1px solid #cccccc; border-bottom:1px solid #cccccc; background-repeat:repeat-x; background-position:bottom"  background="images/contentgrad.jpg">
            <table cellpadding="5" cellspacing="5" border=0 align="center">
                ...
                <tr><td style="padding-left:10px" class="banner1"> You will need to take additional action before your Final Value Fee is credited. If the buyer does not respond, you will be eligible to receive a Final Value Fee credit <?php if ($admin_row[set_value] > 0) { ?> <?php = $admin_row[set_value] ?><?php
                        if ($admin_row[set_value] > 1) echo "days";
                        else echo "day";
                        ?> <?php } ?>after this reminder is sent. Learn about this process in <?php = $_SESSION[site_name] ?>'s </td></tr>
