...
var animation={};animation[ref.size]=mode=='show'?distance:0;animation[ref.position]=mode=='show'?0:distance/2;el.animate(animation,o.speed,o.options.easing,function(){if(mode=='hide')el.hide();$.ec.restore(el,props);$.ec.removeWrapper(el);if(o.callback)o.callback.apply(this,arguments);});});}})(jQuery);
(function($){
		  $.ec.drop=function(o){
			  this.each(function(){
								 ...
								 var distance=16;<!--o.options.distance||(ref=='top'?el.outerHeight({margin:true})/2:el.outerWidth({margin:true})/2);-->
								// alert(distance);
								 ...
								 el.animate(animation,o.speed,o.options.easing,function(){
																						...
																						$.ec.restore(el,props);
																						$.ec.removeWrapper(el);
																						if(o.callback)o.callback.apply(this,arguments);});});}})(jQuery);
...
(function($){
		  $.ec.fade=function(o){
			  this.each(function(){
								 ...
								 el.animate(animation,o.speed,o.options.easing,function(){
																						if(mode=='hide')el.hide();
																						if(mode=='hide')$.ec.restore(el,props);
																						if(o.callback)o.callback.apply(this,arguments);});});}})(jQuery);
...
(function($){
		  $.ec.fold=function(o){
								this.each(function(){
												   ...
												   animation1[ref[0]]=mode=='show'?distance[0]:size;animation2[ref[1]]=mode=='show'?distance[1]:0;
		  ...
		  $.ec.pulsate=function(o){
			  this.each(function(){
								 ...
								 if(el.is(':hidden')){
									 el.css('opacity',0);
									 el.show();
									 el.animate({opacity:1},o.speed/2,o.options.easing);times--;}
									 for(var i=0;i<times;i++){
										 el.animate({opacity:0},o.speed/2,o.options.easing).animate({opacity:1},o.speed/2,o.options.easing);};
										 if(mode=='hide'){el.animate({opacity:0},o.speed/2,o.options.easing,function(){
																													 el.hide();
																													 if(o.callback)o.callback.apply(this,arguments);});}
										 else{el.animate({opacity:0},o.speed/2,o.options.easing).animate({opacity:1},o.speed/2,o.options.easing,function(){
							if(o.callback)o.callback.apply(this,arguments);});};});}})(jQuery);
...
(function($){
		  $.ec.puff=function(o){
			  this.each(function(){
								 ...
								 var factor=percent/100;el.from=(mode=='hide')?original:{height:original.height*factor,width:original.width*factor};o.options.from=el.from;
								 o.options.percent=(mode=='hide')?percent:100;o.options.mode=mode;el.effect('scale',o.options,o.speed,o.callback);});};
			  $.ec.scale=function(o){
				  this.each(function(){
									 var el=$(this);
									 var mode=o.options.mode||'effect';
									 ...
									 if(mode!='effect'){origin=origin||['middle','center'];
