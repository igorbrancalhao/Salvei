...
<tr><td class="banner1"><font color="#FF0000">You must wait <?php= $admin_row[set_value]?> <?php if($admin_row[set_value]==1){ echo "day";} else {echo "days";}?> to open a dispute</font>
</td></tr>
</table></td></tr>
<?php
}
