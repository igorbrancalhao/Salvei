...
$domainname = "http://www.ajauctionpro.com/auction_web2.0";
$adminemail = "antonyprabhu@ajsquare.com";
$adminuser = "admin";
$password1 = "admin";
...
$result = mysql_query($sql);
$sql = "INSERT INTO error_message VALUES (39, 'money_trans', 'Thank You! Your $<?php echo  $amt ?>  successfully transferred to  <?php echo  $trans_username ?>.')";
$result = mysql_query($sql);
...
$result = mysql_query($sql);
$sql = "INSERT INTO error_message VALUES (56, 'cus_support', 'Mail Sent Successfully to <?php echo  $_SESSION[site_name]  ?> Customar Support.')";
$result = mysql_query($sql);
...
$sql = "INSERT INTO `admin` (`admin_id`, `user_name`, `password`, `email`, `status`) VALUES (1, '$adminuser', '$password', '$adminemail', 'main')";
$result = mysql_query($sql);
...
/* $sql="INSERT INTO `mail_subjects` (`mail_id`, `mail_title`, `mail_from`, `mail_subject`, `mail_message`) VALUES (3, 'ask question to a seller', '<buyer_email_id>', '<?php echo  $_SESSION[site_name]  ?>\r\n  Member Ask a  Question', 'Dear <seller_name>,<br>\r\n\r\n <buyer_name> has ask this question regarding your product (<product_name> ).<br> \r\n\r\n<question>\r\n<br>\r\n\r\nBest Regards,<br>\r\n <?php echo  $_SESSION[site_name]?>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n')"; */
$sql = "INSERT INTO `mail_subjects` (`mail_id`, `mail_title`, `mail_from`, `mail_subject`, `mail_message`) VALUES (3, 'ask question to a seller', '<buyer_email_id>', '<?php echo    ?>', '<table width=700 style=\"border-left:1px solid #CCCCCC;border-top:1px solid #CCCCCC; \r\nborder-right:1px solid #cccccc; border-bottom:1px solid #cccccc\">\r\n<tr><td><img src=\'<imgh>\'></td></tr>\r\n<tr><td>\r\nDear <seller_name>,<br>\r\n<buyer_name> has ask this question regarding your product (<product_name> ).<br> \r\n<question> \r\n<br>Best Regards,<br>\r\n<sitename>\r\n</td></tr>\r\n<tr><td><img src=\'<imgf>\'></td></tr>\r\n</table>')";
$result = mysql_query($sql);
...
/* $sql="INSERT INTO `mail_subjects` (`mail_id`, `mail_title`, `mail_from`, `mail_subject`, `mail_message`) VALUES (2, 'email to  friend mail', '$adminemail', '<?php echo  $_SESSION[site_name]  ?>\r\n Member:', '<table bgcolor=#F8F8FA style=border-top:2px solid #979BB3;border-bottom:2px solid #979BB3; cellpadding=5 cellspacing=2 width=50%>\r\n<tr bgcolor=#EEEEF8><td>\r\n<b><font size=2><username> Sent You This <?php echo  $_SESSION[site_name]  ?>\r\n Item.</font></b>\r\n</td></tr>\r\n<tr><td><b>Personal Message:</b><msg></td></tr>\r\n<tr><td>\r\n<a href=<page>>Click Here to View this Item.</a></td></tr></table>')"; */

$sql = "INSERT INTO `mail_subjects` (`mail_id`, `mail_title`, `mail_from`, `mail_subject`, `mail_message`) VALUES (2, 'email to  friend mail', '$adminemail', '<?php echo    ?>', '<table width=700 style=\"border-left:1px solid #CCCCCC;border-top:1px solid #CCCCCC; \r\nborder-right:1px solid #cccccc; border-bottom:1px solid #cccccc\">\r\n<tr><td><img src=\'<imgh>\'></td></tr>\r\n<tr bgcolor=#EEEEF8><td>\r\n<b><font size=2><username> Sent You This <?php echo    ?>\r\n Item.</font></b>\r\n</td></tr>\r\n<tr><td><b>Personal Message:</b><msg></td></tr>\r\n<tr><td>\r\n<a href=<page>>Click Here to View this Item.</a></td></tr>\r\n<tr><td><img src=\'<imgf>\'></td></tr>\r\n</table>')";
$result = mysql_query($sql);
