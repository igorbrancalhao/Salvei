                                        ...
                                        <tr>
                                            <td width="214"><table width="100%" border="0" cellpadding="0" cellspacing="10" background="images/bg081.jpg" class="border1">
                                                    <tr>
                                                        ...
                                                        <td width="26%" class="txt_details"><?php
                                                            if ($tot_rec != 0) echo $tot_rec;
                                                            else echo $norec;
                                                            ?></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="txt_details"><?php
                                                            if ($newitem_rec != 0) echo $newitem_rec;
                                                            else echo $norec;
                                                            ?></td>
                                                    </tr>
                                                    <tr>
