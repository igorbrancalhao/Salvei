...
<form name="frm" method="post" onSubmit="this.cansave.value=1;return true();">
  <tr>
  <td align="left" width="93"><table id="Table_01" width="93"  border="0" cellpadding="0" cellspacing="0">
	...
	{
		if($pmessage) echo $pmessage.'<br>'; 
		if($emessage) echo $emessage;
	}
	?>
	<?php
	if($mode=='edit')
...
?>
	...
	<tr bgcolor="eeeee1"><td><?php if($uflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">Username</font></td>
	<td><input type="text" name="txtUname" value="<?php if($mode=='edit') echo $grow['user_name']; else echo $username ?>" style="<?php=$text ?>"></td></tr>
		<tr bgcolor="eeeee1" ><td><?php if($fnflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">First Name</font></td>
	<td><input type="text" name="firstname" value="<?php if($mode=='edit') echo $grow['first_name']; else echo $firstname ?>" style="<?php=$text ?>"></td></tr>
	
	
	<tr bgcolor="eeeee1"><td><?php if($lnflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">Last Name</font></td>
	<td><input type="text" name="lastname" value="<?php if($mode=='edit') echo $grow['last_name']; else echo $lasstname ?>" style="<?php=$text ?>"></td></tr>
	
	
	<tr bgcolor="eeeee1"><td><?php if($addflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">Address</font></td>
	<td><input type="text" name="address" value="<?php if($mode=='edit') echo $grow['address']; else echo $address ?>" style="<?php=$text ?>"></td></tr>
	
	<tr bgcolor="eeeee1"><td><?php if($pinflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">Pincode</font></td>
	<td><input type="text" name="pincode" value="<?php if($mode=='edit') echo $grow['pin_code']; else echo $pincode ?>" style="<?php=$text ?>"></td></tr>

	<tr bgcolor="eeeee1"><td><?php if($homephoneflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	...
	<tr bgcolor="eeeee1"><td><?php if($workphoneflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
...
<!--	<tr><td><?php if($passflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">Password</font></td>
	<td><input type="text" name="password" value="<?php if($mode=='edit') echo $grow['password']; else echo $password ?>" style="<?php=$text ?>"></td></tr> -->
	...
	<tr bgcolor="eeeee1"><td><?php if($pflag==1 || $pcflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<?php if($mode!='edit')
	{
	?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">Password</font></td>
	<td><input type="password" name="txtPass" style="<?php=$text ?>"></td></tr>
	<tr bgcolor="eeeee1"><td><?php if($cflag==1 || $pcflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	...
	<tr bgcolor="eeeee1"><td><?php if($eflag==1 || $evflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">Email</font></td><td><input type="text" name="txtEmail" value="<?php if($mode=='edit') echo $grow['email']; else echo $email ?>" style="<?php=$text ?>"></td></tr>
	<tr bgcolor="eeeee1"><td><?php if($ctflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	<font face="<?php=$font; ?>" size="<?php=$size; ?>">City</font></td><td><input type="text" name="txtCity" value="<?php if($mode=='edit') echo $grow['city']; else echo $city ?>" style="<?php=$text ?>"></td></tr>
	<tr bgcolor="eeeee1"><td><?php if($coflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	...
	echo '<option value='.$crow['country_id'] .' selected>'.$crow['country'].'</option>';
	else echo '	<option value='.$crow['country_id'].'>'.$crow['country'].'</option>';
	}
	?>
	</select></td></tr>
	<tr bgcolor="eeeee1"><td><?php if($stflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?><font face="<?php=$font; ?>" size="<?php=$size; ?>">State</font></td>
	...
	echo '<option value='.$srow['state_id'] .' selected>'.$srow['state'].'</option>';
	else echo '	<option value='.$srow['state_id'].'>'.$srow['state'].'</option>';
	}
	?>
	</select></td></tr>
	<tr bgcolor="eeeee1"><td><?php if($cflag==1 || $pcflag==1) echo '<font color=#ff0000>'; else echo '<font color=#000000>'; ?>
	...
	<input type="submit" name="submit" class="button" value="<?php if($mode=='edit') echo 'Update'; else echo 'Register'; ?>" style="<?php=$button ?>"></td></tr>
	</table></td>
