...
if ($mode == "edit" || $mode == "new") {
    ...
    <table border="0" align="center" cellpadding="5" cellspacing="2" width="98%" class="border2" >
        <form name="frmPlan" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" onSubmit="this.canSave.value = 1;">
            ...
            <tr bgcolor="#eeeee1"><td colspan="2" align="center"><input type="hidden" name="canSave" value="0"><input type="submit" name="btn_Add" value="<?php if ($mode == 'new') echo ' Add ';else if ($mode == 'edit') echo ' Modify ' ?>" class="button" onclick="return val();"></td></tr>
        </form>
    </table></td></tr></table>
    </td></tr></table>
    <?php
