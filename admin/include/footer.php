...
<tr>
          <td><table id="Table_01" width="780" height="30" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><img src="images/index_02_04_01.jpg" width="30" height="30" alt=""></td>
              <td width="722" height="30" valign="top"><table width="722" height="30" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td background="images/bg13.jpg">&nbsp;</td>
                  </tr>
              </table></td>
              <td><img src="images/index_02_04_03.jpg" width="28" height="30" alt=""></td>
            </tr>
          </table></td>
        </tr>
