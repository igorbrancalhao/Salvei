...
<body>
    ...
    <table border=0 bgcolor=#cccccc cellpadding="5" cellspacing="0" width=100%>
        ...
        <!-- <td><input type=button value="B" onclick='document.execCommand("bold");'></td>-->
            ...
            <td id="b1" style="cursor:hand" onclick='document.execCommand("cut");
                    areades.focus();' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/cut.gif" alt="Cut"></td>
            <td id="b1" style="cursor:hand" onclick='document.execCommand("copy");
                    areades.focus();' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/copy.gif" alt="Copy"></td>
            <td id="b1" style="cursor:hand" onclick='document.execCommand("paste");
                    areades.focus();' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/paste.gif" alt="Paste"></td>
            <td id="b1" style="cursor:hand" onclick='document.execCommand("JustifyLeft");
                    areades.focus();' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/leftA.gif" alt="Align Left"></td>
            <td id="b1" style="cursor:hand" onclick='document.execCommand("JustifyCenter");
                    areades.focus();' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/center.gif" alt="Align Center"></td>
            <td id="b1" style="cursor:hand" onclick='document.execCommand("JustifyRight");
                    areades.focus();' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/rightA.gif" alt="Align Right"></td>
            <td id="b1" style="cursor:hand" onclick='areades.focus();
                    document.execCommand("InsertOrderedList");' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/bulletsO.gif" alt="Ordered List"></td>
            <td id="b1" style="cursor:hand" onclick='areades.focus();
                    document.execCommand("InsertUnOrderedList");' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/bulletsU.gif" alt="UnOrdered List"></td>
            <td>
                <select id="cboFontName" onChange='areades.focus();
                        document.execCommand("FontName", false, this[this.selectedIndex].value);' unselectable="on">
            ...
            <td>
                <select id="cboFontSize" onChange='areades.focus();
                        document.execCommand("FontSize", false, this[this.selectedIndex].value);' unselectable="on">
            ...
            <td id="b1" style="cursor:hand" onclick='areades.focus();
                    document.execCommand("createLink", false);' onmouseover="button_over(this)" onmousedown="button_down(this)" onmouseout="button_out(this)"><img src="images/hyperlink.gif" alt="UnOrdered List"></td>
        </tr>
    </table>
