...
<table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#eeeee1"><td width="15">&nbsp;</td>
   <td width="191"  class="tddis">Minimum Amount</td>
    <td width="169">
     <?php echo $pib_row['currency']." "; echo $pib_row['min_bid_amount']; ?>
    </td>
  </tr>
  ...
  <tr bgcolor="#eeeee1"><td width="15">&nbsp;</td><td >Fixed Amount</td><td><?php echo $pib_row['currency']; echo $pib_row['quick_buy_price']; ?></td></tr>
	<?php
	} 
  ?>
  ...
  <tr bgcolor="#eeeee1"><td width="15">&nbsp;</td>
   <td width="191">Shipping Amount</td>
    <td width="169">
     <?php echo $pib_row['currency']." ";  echo $pib_row['shipping_cost']; ?>
    </td>
  </tr>
...
$photo[5]=$pib_row['picture5']; ?>
  ...
  <?php $bid="select * from placing_bid_item where item_id=$id";
  ...
  ?>
   <tr bgcolor="#eeeee1"><td width="1%">&nbsp;</td>
    ...
    <td>
     <?php if(!empty($bid_row['quantity_sold']))
	 {
...
<!--   <tr><td width="5%">&nbsp;</td>
 ...
 <tr bgcolor="#CCCCCC"><td width="5%">&nbsp;</td><td width="52%" class="tddis"><b>Item Visibility</b></td><td></td></tr>
  <tr  bgcolor="#eeeee1"><td width="5%">&nbsp;</td><td>Gallery Featured</td><td width="43%"> &nbsp;<?php if($gallery=='Yes') echo "Yes";
  else echo "No";
  ?></td></tr>
  <tr bgcolor="#eeeee1"><td width="5%">&nbsp;</td><td>Bold</td><td><?php if($bold=='Yes') echo "Yes";
  else echo "No";?>
  </td></tr>
  <tr bgcolor="#eeeee1"><td width="5%">&nbsp;</td>
  <td>Home Featured</td>
  <td><?php if($home=='Yes') echo "Yes";
  else echo "No"; ?>
  </td></tr>
  <tr bgcolor="#eeeee1"><td width="5%">&nbsp;</td><td>Border</td><td><?php if($border=='Yes') echo "Yes";
  else echo "No"; ?>
  </td></tr>
  <tr bgcolor="#eeeee1"><td width="5%">&nbsp;</td><td>High Light</td><td><?php if($highlight=='Yes') echo "Yes";
  else echo "No"; ?></td></tr>
  <tr bgcolor="#eeeee1"><td width="5%">&nbsp;</td><td>Subtitle Featured</td><td><?php if($subtitle_fea=='Yes') echo "Yes";
  else echo "No"; ?></td></tr>
  <?php
  if($subtitle!='')
  {
