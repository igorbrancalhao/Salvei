...
<?php
	...
	while($reg_row=mysql_fetch_array($reg_res)) {
		if($regionid[$i]==$reg_row['region_id']) echo "<option value=".$reg_row['region_id']." selected>".$reg_row['region_name']."</option>";
		else echo "<option value=".$reg_row['region_id'].">".$reg_row['region_name']."</option>";
	}
?>
</select>
</td> -->
