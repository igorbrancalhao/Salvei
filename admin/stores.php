            ...
            border=0 align="left" bgcolor="white">
              <TBODY>
					  ...
					  <STRONG>STORE STATUS</STRONG>:</TD><td><IMG 
                        hspace=4 src="../images/<?php if($aboutpage_type=='enable') echo 'active.gif'; else echo 'inactive.gif'; ?>" ><SPAN 
                        class=redfont><?php if($aboutpage_type=='enable') echo "<font color=green>inactive </font>"; else echo "<font color=red>active </font>"; ?> </SPAN></TD>
