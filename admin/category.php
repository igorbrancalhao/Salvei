                        ...
                        <tr><td width=93>
                            ...
                            <td align="left">
                                <table width="98%" border="0" cellpadding="5" cellspacing="1" class="border2" align="center">
                                    <form name="category" method="post" action="addcategory.php">
                                        <tr bgcolor="#CCCCCC">
                                            <td width="25%" class="txt_users"><div align="center"><span>Category </span></div></td>
                                            <td width="27%" class="txt_users"><div align="center"><span>Edit</span></div></td>
                                            <td width="22%" class="txt_users"><div align="center">Delete</div></td>
                                        </tr>
                                        ...
                                        <tr bgcolor="eeeee1"> 
                                            <td align="right" colspan="5" > 
                                                ...
                                                if ($curpage != 1) {
                                                    ?>
                                                    <a href="category.php?mode=<?php = $mode; ?>&curpage=<?php = ($curpage - 1); ?>" id="link2">Prev</a> 
                                                    | 
                                                    <?php
                                                }
                                                ?>
                                                ...
                                                if ($total_records > ($start + $end)) {
                                                    ?>
                                                    <a href="category.php?mode=<?php = $mode; ?>&curpage=<?php = ($curpage + 1); ?>" id="link2">Next</a> 
                                                    <?php
                                                }
                                                ?>
                                            </td>
                                        ...
                                        while ($row = mysql_fetch_array($res)) {
                                            ...
                                            ?>		
                                            <tr bgcolor="eeeee1">
                                                <td height="41" align="left" style="padding-left:20px"><?php = $row['category_name']; ?></td>
                                                <td class="txt_sitedetails"><div align="center" >
                                                        <a href="addcategory.php?id=<?php = $row['category_id']; ?>&mode=edit" style="text-decoration:none" id="link1" class="txt_sitedetails">Edit</a></div></td>
                                                <td class="txt_sitedetails"><div align="center" class="style3">
                                                        <a href="category.php?id=<?php = $row['category_id']; ?>&mode=delete"  id="link1" style="text-decoration:none" onClick="javascript:return condelete(<?php = $sqlqry_rows ?>);" class="txt_sitedetails">Delete</a></div></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>	
                                        </td></tr>
                                        <tr bgcolor="eeeee1"><td colspan="3">
                                                <input type="submit" name="add" value="Add Category" class="button"></div>
                                            </td>
                                            <!-- <td ><input type="Button" name="change" value="Change Display Order" class="button" onClick="cat_display();"></td> -->
...
<script language="JavaScript">
    ...
    {
        document.category.action = "change_display_order.php";
