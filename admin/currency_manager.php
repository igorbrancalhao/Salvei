...
$currrency="";
$eq_val="";
if($in_res) echo '<tr><td><div align=center> <font color=red size=+1>Currency added Successfully</font></div></td></tr>';
else echo '<tr><td><div align=center><font color=red>Currency not added</font></div></td></tr>';
...
<?phpif($ef==1){
?> <font color="#FF0000"><?php	echo $err_cur;
$ef=0;?></font>
<?php } ?> 
  </tr>
<tr bgcolor="#eeeee1">
...
<tr bgcolor="eeeee1">
  ...
  <input type="radio" name="rdVal<?php=$i; ?>" value="show" checked><?php }
   else { ?><input type="radio" name="rdVal<?php=$i; ?>" value="show"><?php } ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <?php if($row['statuss']=='hide') { ?>
	<input type="radio" name="rdVal<?php=$i; ?>" value="hide" checked><?php }
	 else { ?><input type="radio" name="rdVal<?php=$i; ?>" value="hide"><?php } ?></td>
